...
definitions = {'definitions': {'Pets': {'type': 'object', 'properties': {'id': {'type': 'integer', 'example': 2}, 'name': {'type': 'string', 'example': 'example'}}}}, 'parameters': {}}

validators = {
    ('pets', 'POST'): {'json': {'$ref': '#/definitions/Pets'}},
}

filters = {
    ('pets', 'POST'): {201: {'headers': None, 'schema': None}, 405: {'headers': None, 'schema': None}},
    ('pets', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/Pets'}}}, 404: {'headers': None, 'schema': None}},
}
